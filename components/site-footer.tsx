  ...
  return (
    <footer className="border-t border-[#0b5d3b]/10 bg-white px-5 py-10 sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <Image src="/assets/be-fit-logo.png" alt="Be Fit" width={130} height={62} className="h-10 w-auto object-contain" />
        ...
        <div className="flex gap-6 text-sm font-semibold text-[#345547]">
          <Link href="/#servicos" className="hover:text-[#078c4b]">Serviços</Link>
          <Link href="/shop" className="hover:text-[#078c4b]">Loja</Link>
